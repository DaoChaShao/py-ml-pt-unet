...
from utils.PT import get_device, DataLoader


class RNNClassificationTrainer(QObject):
    ...
    def _epoch_train(self, dataloader: DataLoader | DataLoader) -> float:
    ...
    def _epoch_valid(self, dataloader: DataLoader | DataLoader) -> tuple[float, float]:
    ...
    def fit(self,
            train_loader: DataLoader | DataLoader, valid_loader: DataLoader | DataLoader,
