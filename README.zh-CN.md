...
**项目简介**
---
[**剑桥驾驶标注视频数据库 (CamVid)**](https://www.kaggle.com/datasets/carlolepelaars/camvid)
是最早为计算机视觉应用提供对象类别语义标签和元数据的自动驾驶数据集之一。该数据集解决了超越简单目标检测的复杂场景理解需求，专注于像素级语义分割任务。
